...
#commented out because this doesn't need to show up in the html: 
...
anova(model_10)['Residuals', 'Mean Sq']
...
intercept). (0.5 pts): The intercept is 656.72 and the coefficient of computer is 0.02
...
• What is the coefficient on computers now?: 0.01 (more specifically, 0.008396) 
• What does that imply about the relationship between computers and income and reading
scores and income?: For each one unit increase in reading score, income also increases by about 1.95. Number of computers and income are also positively correlated to reading scores, but since this regression is concerned with reading scores, it is better to say that as reading scores increase, income and number of computers also increases. 
...
mse_knn5 <- mean((knn_m5$pred - test_CAS[,9])^2)
...
mse_knn10 <- mean((knn_m10$pred - test_CAS[,9])^2)
